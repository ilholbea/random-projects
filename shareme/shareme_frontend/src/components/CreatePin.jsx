...
const CreatePin = ({ user }) => {
    ...
    const uploadImage = (event) => {
        ...
        if (type === 'image/png' || type === 'image/jpg' ||
            type === 'image/svg' || type === 'image/gif' || type === 'image/jpeg') {
    ...
    return (
        <div className='flex flex-col justify-center items-center mt-5 lg:h-4/5'>
            {fields && (
                <p className='text-red-500 mb-5 text-xl transition-all duration-1500 ease-in'>Please fill in all the
                    fields.</p>
            )}
            <div
                className='flex lg:flew-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full'>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <div className='flex justify-end items-end mt-5'>
                            <button type='button' onClick={savePin}
                                    className='bg-red-500 text-white font-bold pd-2 rounded-full w-28 outline-none'>
                                Save Pin
                            </button>
                        </div>
                    </div>
